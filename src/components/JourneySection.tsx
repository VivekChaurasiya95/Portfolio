...
const milestones = [
  {
    ...
    description: 'Expanding to full-stack development. Building end-to-end applications with modern technologies and deploying production systems.',
  ...
  },
  {
    ...
    description: 'Started B.Tech in Computer Science at Madhav Institute of Technology and Science, Gwalior (Graduating 2028). Began exploring advanced concepts.',
    tags: ['B.Tech', 'MITS Gwalior', '2028'],
    type: 'Education',
    icon: GraduationCap,
  },
  {
